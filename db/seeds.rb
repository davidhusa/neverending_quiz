...
riddles = [
  {
    ...
    options: ["Echo", "Whistle", "Cloud", "Shadow"],
    correct_answer: "Echo"
  },
  {
  ...
  },
  {
    ...
    options: ["Thunder", "Wind", "Night", "Ghost"],
  ...
  },
  {
    ...
    options: ["Candle", "Tree", "Book", "Person"],
...
riddles.each do |riddle|
  ...
  riddle[:options].each do |answer|
    Answer.create(answer: answer, correct: answer == riddle[:correct_answer], question: question)
  end
end
